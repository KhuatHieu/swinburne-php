        ...
        <div class="row">
            ...
            <div class="col-75">
                <select id="jobRef" name="jobRefNumber" required>
                    ...
                    <option value="FE024" <?php echo isset($_SESSION["old"]['jobRefNumber']) && $_SESSION["old"]['jobRefNumber'] === 'FE024' ? 'selected' : '' ?>>
                        FE024
                    </option>
                    <option value="BE024" <?php echo isset($_SESSION["old"]['jobRefNumber']) && $_SESSION["old"]['jobRefNumber'] === 'BE024' ? 'selected' : '' ?>>
                        BE024
                    </option>
                </select>
                <p class="text-error">
